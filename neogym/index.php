...
<?php echo get_template_directory_uri(); ?>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="<?php echo get_template_directory_uri(). "/why.html"?>"> Why us </a>
                </li>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo get_template_directory_uri(). "/contact.html"?>"> Contact Us</a>
                </li>
              </ul>
  ...
  <footer class="container-fluid footer_section">
    <p>
      &copy; This Template Customise by 
      <a href="https://www.facebook.com/snigdho.saha.3/">SNIGDHO SAHA</a>
    </p>
  </footer>
  <!-- footer section -->
